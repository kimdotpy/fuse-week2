...
# ══════════════════════════════════════════════════════════════════════════════
# Dashboard schemas — Table counts and overall dashboard
# ══════════════════════════════════════════════════════════════════════════════
...
class OverallCounts(BaseModel):
    ...
    This response is generated by concurrent queries using asyncio.gather()
    to fetch all counts simultaneously, resulting in optimal performance.
    """
    customers: int
    orders: int
    products: int
